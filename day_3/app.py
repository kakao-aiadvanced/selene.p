...
def main():
    ...
    def retrieve(state):
        ...
        return {"documents": documents, "question": question, "source": source, "title": title}
    ...
    def generate(state):
        ...
        return {"documents": documents, "question": question, "generation": generation, "source": source, "title": title}
